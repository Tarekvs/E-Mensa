...
{
    $logger = new \Monolog\Logger('emensalogger');

    $logger->pushHandler(new \Monolog\Handler\StreamHandler($_SERVER['DOCUMENT_ROOT'].'/../storage/logs/emensa.log',\Monolog\Logger::INFO));
